...
def fnConexionServidor():
    ...
    if (fa.fnArchivoExiste(eg.eGlobales.INICIALIZACION)):
        ...
        try:
            ...
            eg.gConnMySql = pymysql.connect(host     = servidor, 
                                                    user     = usuario, 
                                                    passwd   = password,
                                                    database = database)
        ...
        # Captura del Error    
        except pymysql.errors.InterfaceError as err:
        ...
        except pymysql.errors.ProgrammingError as err:
        ...
        fg.fnMensajeInformacion("Error en Archivo de Inicialización",pymysql.errors)
        return False
